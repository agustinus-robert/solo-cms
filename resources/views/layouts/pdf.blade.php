...
<body>
    <header>
        <table>
            <tr>
                {{-- <td width="4" style="vertical-align: middle;"><img src="@yield('logo', asset('/icons/logo-icon-bw-384.png'))" height="45"></td> --}}
        ...
        <div class="footer">
            <table>
                <tr>
                    ...
                    <td style="text-align: right;"><small style="font-size: 8pt;"><i>{{ config('app.name') }}</i></small></td>
                </tr>
            </table>
        </div>
    </header>

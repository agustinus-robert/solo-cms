...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\AuthValidation::class,
            \RalphJSmit\Livewire\Urls\Middleware\LivewireUrlsMiddleware::class,
            \App\Http\Middleware\AppendOutletQuery::class,
        ],
    ...
    protected $middlewareAliases = [
        ...
        'password.confirm' => \Modules\Auth\Http\Middleware\PasswordConfirmation::class,

...
class OutletController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('poz::master.outlet.index', [
            'action' => 'Create'
        ]);
    }
    ...
    public function outletTable()
    {
        ...
        return Table::of($outlet)
            ...
            ->addColumn('action', function ($row) {
                ...
                $template .= view('poz::layouts_master.component.button_edit', array('id' => $row->id, 'update' => route('poz::master.outlet.edit', ['outlet' => $row->id])))->render();
                $template .= view('poz::layouts_master.component.button_delete', array('id' => $row->id, 'delete' => route('poz::master.outlet.destroy', ['outlet' => $row->id])))->render();

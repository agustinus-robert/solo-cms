<div>
                    ...
                    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_primary_container">
                        ...
                        <div class="app-navbar flex-shrink-0">
                            <div class="app-navbar-item">
                                <!--begin:Info-->
                                <a href="javascript:void(0)" class="d-flex flex-column bg-light ms-lg-6 ms-3 rounded px-4 py-1 text-end">
                                    <span class="fs-8 fw-bold text-gray-500">Balance</span>
                                    <span class="fs-5 fw-bold text-gray-800">Rp {{ number_format($cash, 0, ',', '.') }},00</span>
                                </a>
                                <!--end:Info-->
                            </div>
                            <!--end::Balance-->
                            ...
                            <div class="app-navbar-item ms-lg-9 ms-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    ...
                                    <div class="d-none d-sm-flex flex-column justify-content-center me-3 text-end">
                                        <span class="fs-8 fw-bold text-gray-500">Kasir</span>
                                        <a href="javascript:void(0)" class="text-hover-primary fs-7 fw-bold d-block text-gray-800">{{ auth()->user()->name }}</a>
                                    </div>
                                    <!--end:Info-->
                                    <!--begin::User-->
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Logo" src="{{ Auth::user()->profile_avatar_path }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Username-->
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">{{ auth()->user()->name }}
                                                    <span class="badge badge-light-success fw-bold fs-8 ms-2 px-2 py-1">Kasir</span>
                                                </div>
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ route('poz::dashboard', ['outlet' => request()->query('outlet', auth()->user()->current_outlet_id)]) }}" class="menu-link px-5">Dashboard</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    <div class="separator my-2"></div>
                        ...
                        <div class="app-header-slider d-flex flex-stack h-100" wire:ignore>
                            ...
                            <div class="tns tns-fit w-100">
                                ...
                                <div data-tns="true" data-tns-loop="false" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="10000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-gutter="0" data-tns-responsive="{470: {items: 2}, 670: {items: 3, gutter: 15}, 992: {items: 5, gutter: 20}, 1300: {items: 6, gutter: 40}}" data-tns-center="false" data-tns-dots="false"
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#SaldoModal" class="parent-hover d-flex align-items-center flex-md-row-fluid py-lg-2 cursor-pointer px-0">
                                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                                            <span class="symbol-label rounded-4">
                                                <div class="d-flex flex-center h-80px mb-2 rounded bg-gray-100 p-4">
                                                    <i class="ki-duotone ki-tag text-gray-900 fs-2tx"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                </div>
                                            </span>
                                        </div>

                                        <div class="d-flex justify-content-center flex-column">
                                            <span class="fw-bold parent-hover-primary fs-5 mb-1 text-gray-800">Saldo</span>
                                            <span class="fw-semibold d-block fs-7 text-gray-500">Tambah Saldo Kembalian</span>
                                        </div>
                                    </a>

                                    <a onclick="loadQueueToLivewire()" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#QueueModal" class="parent-hover d-flex align-items-center flex-md-row-fluid py-lg-2 cursor-pointer px-0">
                                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                                            <span class="symbol-label rounded-4">
                                                <div class="d-flex flex-center h-80px mb-2 rounded bg-gray-100 p-4">
                                                    <i class="ki-duotone ki-handcart text-gray-900 fs-2tx"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                </div>
                                            </span>
                                        </div>

                                        <div class="d-flex justify-content-center flex-column">
                                            <span class="fw-bold parent-hover-primary fs-5 mb-1 text-gray-800">Antrian</span>
                                            <span class="fw-semibold d-block fs-7 text-gray-500">kelola Antrian</span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
                                ...
                                <div class="d-flex flex-column flex-xl-row">
                                    <!--begin::Content-->
                                        <div class="flex-grow-1 me-xl-9 mb-xl-0 mb-10">
                                        ...
                                        <div class="card card-flush card-p-0 border-0 bg-transparent">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!--end::Nav-->
                                                <!--begin::Tab Content-->
                                                @livewire('poz::transaction.pos-product-list', ['products' => $products, 'inv' => $inv])
                                                <!--end::Tab Content-->
                                            </div>
                                            <!--end: Card Body-->
                                        </div>
                                    ...
                                    <!--end::Content-->
                                    <!--begin::Sidebar-->
                                    @livewire('poz::transaction.pos-order-summary', ['products' => $products, 'inv' => $inv])                                    <!--end::Sidebar-->
                                </div>
                                <!--end::Layout-->
                            </div>
                            <!--end::Content-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div class="d-flex align-items-center min-w-700px rounded border border-dashed border-gray-300 p-7">
                                        ...
                                        <div class="overlay">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="w-150px rounded" src="" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark rounded bg-opacity-10">
    ...
    <div class="modal fade" id="SaldoModal" tabindex="-1" role="dialog" aria-labelledby="discountModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="discountModalLabel">Saldo Kembalian</h5>
                ...
                <div class="modal-body">
                    <label for="discount">Isi Saldo Kembalian</label>
                    <!-- Input discount menggunakan Livewire -->
                    <input type="number" class="form-control" wire:model.defer="moneyRegistration">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <!-- Tombol submit yang akan menyimpan nilai discount -->
                    <button type="button" wire:click="applySaled" class="btn btn-primary">Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        window.addEventListener('close-saldo-modal', event => {
            var myModalEl = document.getElementById('SaldoModal');

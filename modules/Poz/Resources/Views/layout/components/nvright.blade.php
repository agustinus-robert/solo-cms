                ...
                <div class="block-content block-content-full">
                    <div class="row g-sm text-center">
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-default py-3 text-white" data-toggle="theme" data-theme="default" href="javascript:void(0)">
                                Default
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xwork py-3 text-white" data-toggle="theme" data-theme="{{ asset('css/themes/xwork.min.css') }}" href="javascript:void(0)">
                                xWork
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xmodern py-3 text-white" data-toggle="theme" data-theme="{{ asset('backendPos/css/themes/xmodern.min.css') }}" href="javascript:void(0)">
                                xModern
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xeco py-3 text-white" data-toggle="theme" data-theme="{{ asset('backendPos/css/themes/xeco.min.css') }}" href="javascript:void(0)">
                                xEco
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xsmooth py-3 text-white" data-toggle="theme" data-theme="{{ asset('backendPos/css/themes/xsmooth.min.css') }}" href="javascript:void(0)">
                                xSmooth
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xinspire py-3 text-white" data-toggle="theme" data-theme="{{ asset('backendPos/css/themes/xinspire.min.css') }}" href="javascript:void(0)">
                                xInspire
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xdream py-3 text-white" data-toggle="theme" data-theme="a{{ asset('backendPos/css/themes/xdream.min.css') }}" href="javascript:void(0)">
                                xDream
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xpro py-3 text-white" data-toggle="theme" data-theme="{{ asset('backendPos/css/themes/xpro.min.css') }}" href="javascript:void(0)">
                                xPro
                            </a>
                        </div>
                        <div class="col-4 mb-1">
                            <a class="d-block fs-sm fw-semibold bg-xplay py-3 text-white" data-toggle="theme" data-theme="{{ asset('backendPos/css/themes/xplay.min.css') }}" href="javascript:void(0)">
                                xPlay
                            </a>
                        </div>
                        <div class="col-12">

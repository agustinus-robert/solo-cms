        ...
        <ul class="sub-menu mm-collapse">
            <li class="nav-main-item">
                <a href="{{ route('poz::transaction.sale.index', request()->query()) }}" class="nav-main-link">
                    <span class="nav-main-link-name">Daftar Penjualan</span>
                </a>
            </li>

            <li class="nav-main-item">
                <a href="{{ route('poz::transaction.sale.create', request()->query()) }}" class="nav-main-link">
                    <span class="nav-main-link-name">Penjualan Reguler</span>
                </a>
            </li>

            <li class="nav-main-item">
                <a href="{{ route('poz::transaction.sale.create', array_merge(request()->query(), ['pos' => 'true'])) }}" class="nav-main-link">

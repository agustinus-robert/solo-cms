<ul class="metismenu list-unstyled" id="side-menu">
    ...
    <li class="nav-main-item">
        <a class="nav-main-link {{ Route::is('account::manage-role.*') ? 'active' : '' }}" href="{{ route('account::manage-role.index') }}">
    ...
    <li class="nav-main-item">
        <a class="nav-main-link {{ Route::is('account::manage-user.*') ? 'active' : '' }}" href="{{ route('account::manage-user.index') }}">
    ...
    <li class="nav-main-item">
        <a class="nav-main-link {{ Route::is('account::manage-outlet.*') ? 'active' : '' }}" href="{{ route('account::manage-outlet.index') }}">

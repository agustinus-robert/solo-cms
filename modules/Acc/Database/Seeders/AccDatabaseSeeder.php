...
class AccDatabaseSeeder extends Seeder
{
    ...
    private function seedCoa()
    {
        $coaData = [
            // ASSETS
            ['code' => '1101', 'name' => 'Kas Utama', 'category' => 'asset', 'normal_balance' => 'debit'],
            ['code' => '1102', 'name' => 'Bank Utama', 'category' => 'asset', 'normal_balance' => 'debit'],
            ['code' => '1201', 'name' => 'Piutang Tamu', 'category' => 'asset', 'normal_balance' => 'debit'],
            ['code' => '1301', 'name' => 'Persediaan Barang POS', 'category' => 'asset', 'normal_balance' => 'debit'],
            // LIABILITIES
            ['code' => '2101', 'name' => 'Hutang Dagang', 'category' => 'liability', 'normal_balance' => 'credit'],
            ['code' => '2201', 'name' => 'Titipan Deposit Tamu', 'category' => 'liability', 'normal_balance' => 'credit'],
            // EQUITY
            ['code' => '3101', 'name' => 'Modal Pemilik', 'category' => 'equity', 'normal_balance' => 'credit'],
            ['code' => '3201', 'name' => 'Laba Ditahan', 'category' => 'equity', 'normal_balance' => 'credit'],
            // REVENUE
            ['code' => '4101', 'name' => 'Pendapatan Kamar Hotel', 'category' => 'revenue', 'normal_balance' => 'credit'],
            ['code' => '4201', 'name' => 'Pendapatan Paket Tour', 'category' => 'revenue', 'normal_balance' => 'credit'],
            ['code' => '4301', 'name' => 'Pendapatan Penjualan POS', 'category' => 'revenue', 'normal_balance' => 'credit'],
            // EXPENSES
            ['code' => '5101', 'name' => 'HPP POS', 'category' => 'expense', 'normal_balance' => 'debit'],
            ['code' => '5201', 'name' => 'Beban Gaji Karyawan', 'category' => 'expense', 'normal_balance' => 'debit'],
            ['code' => '5202', 'name' => 'Beban Listrik, Air & WiFi', 'category' => 'expense', 'normal_balance' => 'debit'],
            ['code' => '5301', 'name' => 'Beban Komisi Vendor / Guide', 'category' => 'expense', 'normal_balance' => 'debit'],
        ];

    ...
    <div class="row justify-content-center">
        <div class="col-xxl-8 col-xl-10">
            ...
            <div class="card mb-4 border-0">
                <div class="card-body">
                    <form class="form-block" action="{{ route('core::company.services.leave-student-categories.update', ['category' => $category->id, 'next' => request('next')]) }}" method="POST"> @csrf @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-8 col-xxl-6">
                                <select class="@error('parent_id') is-invalid @enderror form-select" name="parent_id">

...
<div class="row justify-content-center">
    <div class="col-xxl-8 col-xl-10">
        ...
        <div class="card mb-4 border-0">
            <div class="card-body">
                <form class="form-block" action="{{ route('core::company.services.leave-categories.store', ['next' => request('next')]) }}" method="POST"> @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-xl-8 col-xxl-6">
                            <select class="form-select @error('parent_id') is-invalid @enderror" name="parent_id" value="{{ old('parent_id') }}">

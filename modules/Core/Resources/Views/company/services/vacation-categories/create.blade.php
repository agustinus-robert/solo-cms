...
<div class="row justify-content-center">
    <div class="col-xxl-8 col-xl-10">
        <div class="d-flex align-items-center mb-4">
            ...
            <div class="ms-4">
                <h2 class="mb-1">Buat kategori cuti baru</h2>
                <div class="text-secondary">Silakan isi formulir di bawah ini untuk membuat kategori cuti baru</div>
            </div>
        </div>
        <div class="card mb-4 border-0">
            <div class="card-body">
                <form class="form-block" action="{{ route('core::company.services.vacation-categories.store', ['next' => request('next')]) }}" method="POST"> @csrf
                        ...
                        <div class="col-md-4">
                            @foreach (['options', 'range'] as $v)
                                <div class="form-check">
                                    <input class="form-check-input only_one" type="radio" id="fields_{{ $v }}" value="{{ $v }}" name="fields" @if(old('fields') == $v) checked @endif required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="as_freelance" value="1" name="as_freelance" @if(old('as_freelance')) checked @endif>
                                <label class="form-check-label" for="as_freelance"><span id="as_freelance-text">@if(old('as_freelance')) Ya, kategori ini menyediakan mode freelance @else Tidak, kategori ini tidak menyediakan mode freelance @endif</span></label>
                            </div>
                            @error('as_freelance')
                                <small class="text-danger d-block"> {{ $message }} </small>
                            @enderror

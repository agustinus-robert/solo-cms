    ...
    <div class="row justify-content-center">
        <div class="col-xxl-8 col-xl-10">
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="ms-4">
                    <h2 class="mb-1">Buat divisi baru</h2>
                    <div class="text-secondary">Silakan isi formulir di bawah ini untuk membuat divisi baru</div>
                </div>
            </div>
                            ...
                            <div class="col-xl-8 col-xxl-6">
                                <select class="form-select @error('parent_id') is-invalid @enderror" name="parent_id">
                                    @forelse($departments as $_department)
                                        ...
                                        @endif
                                        <option value="{{ $_department->id }}" @selected($_department->id == old('parent_id'))>{{ $_department->name }}</option>
                                    @empty

...
<div class="mb-3">
    ...
    <input type="text" class="form-control mb-3" name="calculation" aria-describedby="calc" required />
    <div class="alert alert-primary" role="alert">
        <strong>Keterangan</strong> <br>
        <p>Gaji pokok dilambangkan dengan huruf <strong>"p"</strong><br>
            Contoh penulisan: <strong>((p/20)/8) * (135/100)</strong></p>
    </div>

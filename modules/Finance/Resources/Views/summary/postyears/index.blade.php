    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card border-0">
                ...
                <div class="card-body border-top">
                    <form class="form-block row gy-2 gx-2" action="{{ route('finance::summary.postyear.index', request()->all()) }}" method="get">
                        ...
                        <div class="col-auto">
                            <a class="btn btn-light" href="{{ route('finance::summary.postyear.index', request()->only('trashed')) }}"><i class="mdi mdi-refresh"></i> <span class="d-sm-none">Reset</span></a>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-4">
            <div class="card border-0">
                ...
                <div class="card-body border-top">
                    <form class="form-block" action="{{ route('finance::summary.postyear.index') }}" method="get">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="btn btn-light" href="{{ route('finance::summary.postyear.index') }}"><i class="mdi mdi-refresh"></i> Reset</a>
                        </div>
                    </form>
                </div>
            </div>

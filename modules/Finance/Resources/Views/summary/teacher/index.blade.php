                    ...
                    <table class="mb-0 table align-middle">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Beban Mengajar</th>
                                <th class="text-center">Kelebihan Mengajar</th>
                                <th class="text-center">Extra Mengajar</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($employees as $employee)
                                ...
                                <tr @class(['table-active text-muted' => is_null($employee->contract)])>
                                    ...
                                    <td class="text-center">
                                        @if ($summary->count())
                                            {{ $summary->first()->result->extrahour }}
                                        @else
                                            <span class="text-muted">&dash;</span>
                                        @endif
                                    </td>

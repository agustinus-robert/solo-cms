                        ...
                        <table class="table-hover table-bordered table">
                            ...
                            <tbody class="calc-tbody">
                                @foreach ($periods as $k => $period)
                                    ...
                                    @php($tmp = $tmps->flatten(1))
                                    <tr class="period-tr">
                                        <td>
                                            <input class="form-control" data-name="el.m" type="month" data-id="{{ $tmp->first()->id ?? '' }}" data-item="{{ $tmp ? $tmp->first()->items->pluck('id') : [0] }}" onkeyup="renderAmountSubTotal()" value="{{ $month }}">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input class="form-control group-{{ $tmp->first()->id }} me-2" data-name="el.subtotal_amount" type="number" readonly>
                                        </td>
                                        <td>

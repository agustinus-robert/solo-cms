    ...
    <div class="row">
                            ...
                            @forelse($employees as $employee)
                                <tr>
                                    ...
                                    <td class="py-2 text-end" nowrap>
                                        <a class="btn {{ $total ? 'btn-soft-warning' : 'btn-soft-primary' }} rounded px-2 py-1" href="{{ route('finance::summary.feastday.create', ['employee' => $employee->id, 'cutoff_at' => $cutoff_at->format('Y-m-d'), 'next' => url()->full()]) }}" data-bs-toggle="tooltip" title="Hitung"><i class="mdi {{ $total ? 'mdi-pencil-outline' : 'mdi-plus-circle-outline' }}"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
        ...
        <div class="col-xl-4">
            <div class="card border-0">
                ...
                <div class="card-body border-top">
                    <form class="form-block" action="{{ route('finance::summary.feastday.index') }}" method="get">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="btn btn-light" href="{{ route('finance::summary.feastday.index') }}"><i class="mdi mdi-refresh"></i> Reset</a>
                        </div>
                    </form>
                </div>
            </div>

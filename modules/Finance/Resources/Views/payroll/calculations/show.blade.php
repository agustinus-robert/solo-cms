        ...
        <section>
            ...
            <div style="font-size: 7pt;">
                ...
                <div>
                                            ...
                                            <div>
                                                ...
                                                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    <tbody>
                                                        ...
                                                        @if ($slip['az'] == 2)
                                                            @php($item38 = collect($items)->firstWhere('component_id', 38))
                                                            @php($item39 = collect($items)->firstWhere('component_id', 39))
                                                            @php($selisih = isset($item38['amount'], $item39['amount']) ? $item39['amount'] - $item38['amount'] : null);
                                                        @endif
                    ...
                    <br>
                    @if ($slip['az'] == 2 && isset($ctg['i']))
                        <div class="border-y">
                            <div><cite><strong>Selisih rate extra: {{ number_format($selisih) }}</strong></cite></div>
                        </div>
                    @endif

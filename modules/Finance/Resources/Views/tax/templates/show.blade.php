    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="ms-4">
                    <h2 class="mb-1">Ubah template pph21</h2>
                    <div class="text-secondary">Silakan isi formulir di bawah untuk mengubah data template pph21 perusahaan</div>
                </div>
            </div>
                                                ...
                                                <tbody>
                                                    @foreach ($components->filter(fn($item) => $item['ctg_az'] == $loop->iteration && $item['slip_az'] == $loop->parent->iteration) as $stg_component)
                                                        <tr class="form-index has-add-button">
                                                            ...
                                                            <td valign="middle" style="min-width: 120px;" class="text-center">
                                                                <input class="form-check-input mt-0" data-name="multiplier" type="checkbox" value="1">
                                                            </td>
                                                            <td>
...
@push('scripts')
    <script>
        ...
        const renderUnitComponent = (el) => {
            ...
            let multiplier = (checked && checked.dataset.multiplier);
            el.parentNode.closest('tr').querySelector('[data-name="multiplier"]').checked = multiplier ? true : false;

                        ...
                        <tr class="calc-row @if ($loop->first) calc-row-template @endif">
                            ...
                            <td>
                                <div class="input-group flex-nowrap">
                                    <input type="number" class="form-control reduction-month-amount text-end" name="reduction[ctgs][{{ $loop->parent->index }}][item][{{ $loop->index }}][monthly]" value="{{ $x = $item['real_salary'] }}" onchange="sumSubTotal(event)" onkeyup="sumSubTotal(event)" required>
                                </div>
                            </td>
                        </tr>
                    @endforeach

...
class CoordinatorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('finance::summary.coords.index', [
            'start_at'    => $start_at,
            'end_at'      => $end_at,
    ...
    public function show(Employee $employee, Request $request)
    {
        ...
        return view('finance::summary.coords.show', compact('start_at', 'end_at', 'employee', 'userNow', 'attendance', 'results', 'status'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('finance::summary.coords.create', [
            'employee'   => $employee,
            'start_at'   => $start_at,
            'end_at'     => $end_at,
            ...
            if (ApprovableResultEnum::APPROVE->value == (int) $request->result) {
                ...
                if ((int) $request->result == ApprovableResultEnum::APPROVE->value && $submission) {
                    ...
                    EmployeeDataRecapitulation::create([
                        'empl_id' => $submissionCoor->empl_id,
    ...
    public function update(Employee $employee, UpdateRequest $request)
    {
        ...
        $attendance = EmployeeRecapSubmission::with('approvables')
            ->where(['empl_id' => $request->employee, 'start_at' => $start_at, 'end_at' => $end_at]);

                                        ...
                                        @unless ($overtime->trashed())
                                            ...
                                            <div class="dropstart d-inline">
                                                ...
                                                <ul class="dropdown-menu border-0 shadow">
                                                    <li><a class="dropdown-item" href="{{ route('hrms::service.overtime.manage.show', ['overtime' => $overtime->id, 'next' => request('next')]) }}"><i class="mdi mdi-eye-outline me-1"></i> Lihat detail</a></li>
                                                    @if (isset($overtime->attachment) && Storage::exists($overtime->attachment))
                                                ...
                                                <table class="table-borderless table-hover table-sm mb-0 table align-middle">
                                                    <thead>
                                                        <tr class="text-muted small bg-light">
                                                            ...
                                                            <th class="border-bottom fw-normal">Aktivitas</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($overtime->approvables as $approvable)
                                                            <tr>
                                                                ...
                                                                <td class="small">{{ $approvable->result->value > 0 ? $approvable->updated_at?->isoFormat('lll') : '' }}</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
        ...
        <div class="col-xl-4">
            <div class="card border-0">
                ...
                <div class="card-body border-top">
                    <form class="form-block" action="{{ route('hrms::service.overtime.manage.index') }}" method="get">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="select-positions">Pencarian</label>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="btn btn-light" href="{{ route('hrms::service.overtime.manage.index') }}"><i class="mdi mdi-refresh"></i> Reset</a>
                        </div>
                    </form>
                </div>
            </div>
            <div class="card border-0">
                ...
                <div class="list-group list-group-flush border-top">
                    <a class="list-group-item list-group-item-action text-danger" href="{{ route('hrms::service.overtime.manage.index', ['pending' => !request('pending')]) }}"><i class="mdi mdi-progress-clock"></i> {{ request('pending') == 1 ? 'Tampilkan semua pengajuan' : 'Hanya tampilkan pengajuan yang tertunda' }}</a>
                </div>
            </div>
            <div class="card border-0">
                <div class="card-body">

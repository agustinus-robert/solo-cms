...
@section('content')
    <div class="d-flex align-items-center mb-4">
        <a class="text-decoration-none" href="{{ request('next', route('hrms::summary.postyears.index')) }}"><i class="mdi mdi-arrow-left-circle-outline mdi-36px"></i></a>
        <div class="ms-4">
    ...
    <div class="row">
        ...
        <div class="col-xxl-8 order-xxl-first">
            <div class="card border-0">
                ...
                <form class="form-confirm form-block" action="{{ route('hrms::summary.postyears.store', ['employee' => $employee->id, 'next' => request('next', route('hrms::summary.postyears.index'))]) }}" method="post"> @csrf
                    <div class="card-body">

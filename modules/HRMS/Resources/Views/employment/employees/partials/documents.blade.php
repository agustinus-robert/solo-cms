<div class="card border-0">
    <div class="card-body"><i class="mdi mdi-file-account-outline"></i> Dokumen PPh21 karyawan</div>

    <div class="card-body border-bottom mb-3">
        <form action="{{ route('hrms::employment.user-document.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="employee" value="{{ $employee->id }}" />
            <div class="row g-3 align-items-end">
                <div class="col-md-4">
                    <label class="form-label small fw-bold">Nama Dokumen</label>
                    <input type="text" class="form-control" name="document_name" placeholder="Doc: KTP/KK/Surat Keterangan" required>
                </div>
                <div class="col-md-5">
    ...
    <div class="table-responsive border-top">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <form action="{{ route('hrms::system.user-document.destroy', $doc->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted small">Silakan unggah dokumen menggunakan form di atas.</p>
        </div>
        @endif
    </div>
</div>

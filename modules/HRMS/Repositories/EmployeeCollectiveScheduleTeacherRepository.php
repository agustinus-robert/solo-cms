    ...
    public function storeEmployeeSchedule(array $data, $employee)
    {
        ...
        try {
            ...
            foreach ($data['data'] as $resultKeyData => $resultValueData) {
                ...
                $existingRecord = EmployeeScheduleSubmissionTeacher::where(['start_at' => $startAt, 'end_at' => $endAt, 'empl_id' => $resultKeyData])->first();
                ...
                if ($existingRecord) {
                    ...
                    $schedule = new EmployeeScheduleSubmissionTeacher([

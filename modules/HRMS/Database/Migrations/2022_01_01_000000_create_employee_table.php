...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('empls', function (Blueprint $table) {
            $table->smallIncrements('id'); // PostgreSQL: smallserial
        ...
        Schema::create('empl_overtimes', function (Blueprint $table) {
            ...
            $table->decimal('paid_amount', 20, 2)->nullable(); // Decimal lebih aman untuk uang di Postgres
        ...
        Schema::create('empl_outworks', function (Blueprint $table) {
            ...
            $table->string('attachment')->nullable();
            $table->timestamp('paidable_at')->nullable();
            $table->decimal('paid_amount', 15, 2)->nullable(); // Diubah dari float ke decimal
            $table->timestamp('paid_off_at')->nullable();
            $table->softDeletes();
            $table->timestamps();
        ...
        Schema::create('empl_insurances', function (Blueprint $table) {
            ...
            $table->decimal('cmp_price', 15, 2)->default(0); // Gunakan decimal untuk presisi uang
            $table->decimal('empl_price', 15, 2)->default(0);
        ...
        Schema::create('empl_recap_transfer_submissions', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedSmallInteger('empl_id');
            $table->unsignedTinyInteger('type');
            $table->date('start_at');
    ...
    {
        // Dropping must be in reverse order due to foreign keys
        Schema::dropIfExists('empl_recap_transfer_submissions');
        Schema::dropIfExists('empl_recap_submissions');
        Schema::dropIfExists('empl_schedule_submissions');
        Schema::dropIfExists('empl_deductions');
        ...
        Schema::dropIfExists('empl_salary_template_items');
        Schema::dropIfExists('empl_salary_templates');
        Schema::dropIfExists('empl_insurances');
        Schema::dropIfExists('empl_outworks');
        Schema::dropIfExists('empl_overtimes');
        Schema::dropIfExists('empl_leaves');
        Schema::dropIfExists('empl_vacations');
        Schema::dropIfExists('empl_vacation_quotas');
        Schema::dropIfExists('empl_positions');
        Schema::dropIfExists('empl_schedules');
        Schema::dropIfExists('empl_contract_meta');
        Schema::dropIfExists('empl_contracts');
        Schema::dropIfExists('empl_meta');

...
class ScanlogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $datascanlogs = EmployeeScanLog::with('employee.user', 'employee.contract.position.position')
        ...
        return view('hrms::service.attendance.scanlogs.index', compact('start_at', 'end_at', 'departments', 'scanlogs', 'locations'));
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        $scan = new EmployeeScanLog($input);

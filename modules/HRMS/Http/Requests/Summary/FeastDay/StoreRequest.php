...
namespace Modules\HRMS\Http\Requests\Summary\FeastDay;
...
class StoreRequest extends FormRequest
{
    ...
    public function transform()
    {
        ...
        $cmpsal        = collect(CompanySalaryTemplate::whereJsonContains('meta->feastday', true)->first()->components)->flatten(1);

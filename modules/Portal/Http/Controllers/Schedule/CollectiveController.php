...
use Modules\HRMS\Repositories\EmployeeCollectiveScheduleRepository;
...
{
    use EmployeeRepository, EmployeeCollectiveScheduleRepository;
    ...
    public function create(Request $request)
    {
        ...
        $calendarData = EmployeeSchedule::whereMonth('start_at', $month) // Ambil berdasarkan bulan
        ...
        return view('portal::schedules.manage.collective.create', compact('user', 'employees', 'employee_count', 'month', 'workshifts', 'calendarData', 'type', 'databaseResult', 'label'));
    }
    ...
    {
        // dd($request->transformed()->toArray());

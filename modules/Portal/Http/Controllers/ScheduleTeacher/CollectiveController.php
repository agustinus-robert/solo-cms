...
class CollectiveController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('portal::schedules_teacher.manage.collective.create', compact('user', 'employees', 'employee_count', 'month', 'workshifts', 'calendarData', 'type', 'databaseResult', 'label'));
    }

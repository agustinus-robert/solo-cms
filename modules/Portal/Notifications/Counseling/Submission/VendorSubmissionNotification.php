...
namespace Modules\Portal\Notifications\Counseling\Submission;
...
class VendorSubmissionNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action('Periksa sekarang', route(config('modules.counseling.features.counselor_route'), ['counseling' => $this->counseling->id]))
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'color' => 'info',
            'link' => route(config('modules.counseling.features.counselor_route'), ['counseling' => $this->counseling->id])
        ];
    }

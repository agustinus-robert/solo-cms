...
class RevisedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Seseorang mengubah hari libur')
            ->greeting('Seseorang mengubah hari libur')
            ->line($this->holiday->employee->user->name . ' mengubah tanggal libur, klik tombol di bawah untuk lihat detailnya.')
    ...
    {
        return [
            'message' => $this->holiday->employee->user->name . ' mengubah hari libur, cek sekarang!',

...
class ApprovedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return [
            'message' => 'Selamat! Pengajuan ' . $this->label . ' kamu sebanyak ' . collect($this->vacation->dates)->count() . ' hari untuk keperluan ' . ($this->vacation->description ?: 'istirahat') . ' telah disetujui oleh ' . $this->approvable->userable->position->level->label() . '.',

...
class ApprovedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return [
            'message' => 'Selamat! Pengajuan izin ' . $this->leave->category->name . ' kamu untuk keperluan ' . ($this->leave->description ?: 'istirahat') . ' telah disetujui oleh ' . $this->approvable->userable->position->level->label() . '.',

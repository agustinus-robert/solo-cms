...
namespace Modules\Portal\Notifications\ScheduleTeacher\Submission\AllocateSubmission;
...
class RevisedNotification extends Notification implements ShouldQueue
{
     ...
     */
    public function __construct(EmployeeScheduleSubmissionTeacher $schedule)
    {

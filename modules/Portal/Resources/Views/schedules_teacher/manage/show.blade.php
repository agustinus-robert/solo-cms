...
@section('content')
    ...
    <div class="card mb-4 border-0">
        <div class="card-body">
            <form class="form-block" action="{{ route('portal::schedule.manages.update', ['schedule' => $schedule->id, 'next' => request('next')]) }}" method="POST"> @csrf @method('PUT')
                ...
                <div class="row required mb-3">
                    ...
                    <div class="col-xl-8 col-xxl-6">
                        <input type="text" class="form-control" value="{{ $schedule->employee->position->position->name }}" readonly />
                    </div>
                </div>
                <div class="row required mb-5">
                ...
                <div class="card-body border-top">
                                            ...
                                            <div class="col-xl-{{ 12 / count($workshifts) }}">
                                                <div class="d-flex">
                                                    <div class="form-check py-2">
                                                        <input class="form-check-input" type="checkbox" value="" id="" data-in="{{ $shift->defaultTime()['in'][0] }}" data-out="{{ $shift->defaultTime()['out'][0] }}" onclick="renderMe(event)" @checked(isset($schedule->dates[$date][$i][0])) {{ $class }} />
                                                    </div>
                                                    <div class="input-group">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-8 offset-lg-4 offset-xl-3">
                            ...
                            <a class="btn btn-ghost-light text-dark" href="{{ request('next', route('portal::schedule.manages.index')) }}"><i class="mdi mdi-arrow-left"></i> Kembali</a>
                        </div>
                    </div>
                </div>
            </form>

    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card border-0">
                ...
                <div class="card-body border-top border-light">
                    <form class="form-block form-confirm" action="{{ route('portal::recapitulation.teachers.update', ['attendance' => $attendance->id, 'employee' => $attendance->empl_id, 'start_at' => $attendance->start_at->format('Y-m-d'), 'end_at' => $attendance->end_at->format('Y-m-d'), 'next' => request('next', route('hrms::summary.attendances.index'))]) }}" method="post"> @csrf @method('PUT')
                        <div class="row gy-4">
                            <div class="col-lg-6">

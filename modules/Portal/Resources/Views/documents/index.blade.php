...
<div class="d-flex align-items-center mb-4">
    <a class="text-decoration-none" href="{{ request('next', route('portal::tax.payers.index')) }}"><i class="mdi mdi-arrow-left-circle-outline mdi-36px"></i></a>
    <div class="ms-4">
        <h2 class="mb-1">Dokumen Anda</h2>
        <div class="text-muted">Silahkan kelola Dokumen Anda</div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                <form action="{{ route('portal::files.document.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-sm-12">
            ...
            @endif
            <a class="btn btn-outline-secondary w-100 d-flex text-dark mb-3 rounded bg-white py-3 text-start" style="border-style: dashed;" href="{{ route('portal::schedule.manages.index') }}">
            ...
            <a class="btn btn-outline-primary w-100 d-flex text-primary mb-3 rounded bg-white py-3 text-start" style="border-style: dashed;" href="{{ route('portal::schedule.submission.index') }}">

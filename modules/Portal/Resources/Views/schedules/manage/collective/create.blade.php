...
@section('content')
    <div class="d-flex align-items-center mb-4">
        <a class="text-decoration-none" href="{{ request('next', route('portal::schedule.submission.index')) }}"><i class="mdi mdi-arrow-left-circle-outline mdi-36px"></i></a>
        <div class="ms-4">
    ...
    <div class="row">
        <div class="col-xl-9 col-sm-12">
            <div class="card border-0">
                <div class="card-body d-flex align-items-center justify-content-between py-2">
                    ...
                    <form class="tg-steps-presence-history" action="{{ route('portal::schedule.manages.collective') }}" method="GET">
        ...
        <div class="col-xl-3 col-sm-12 fixed-column mb-3">
            <div class="card border-0">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('portal::schedule.manages.collective.store') }}" enctype="multipart/form-data">@csrf

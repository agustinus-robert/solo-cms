...
use Modules\Cms\Models\ContactOrganization;
...
class ContactOrgDatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('pesan', function ($row) {
                $template = '';
                $template .= view('cms::layouts_master.component.button_view', array('id' => $row->id))->render();
                return $template;
            })
            ->addIndexColumn()
            ->rawColumns(['pesan']);
     ...
     */
    public function query(ContactOrganization $model)
    {

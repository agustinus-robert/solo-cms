...
@section('content')
    ...
    <div class="toolbar mb-lg-7 mb-5" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex fw-bold fs-3 my-1 text-gray-900">Contact</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-semibold fs-7 my-1 text-gray-600">
                ...
                <li class="breadcrumb-item text-gray-600">Contact</li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
        <!--end::Page title-->
    ...
    <div class="content flex-column-fluid" id="kt_content">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                @livewire('cms::datatables.contact-datatable')
            </div>
        </div>
    </div>

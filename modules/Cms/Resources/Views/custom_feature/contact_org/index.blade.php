...
@section('title', 'Contact Organization')

@section('navtitle', 'Contact Organization')
...
@section('content')
    ...
    <div class="toolbar mb-lg-7 mb-5" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex fw-bold fs-3 my-1 text-gray-900">Contact Organization</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-semibold fs-7 my-1 text-gray-600">
                ...
                <li class="breadcrumb-item text-gray-600">Contact Organization</li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
        <!--end::Page title-->
    ...
    <div class="content flex-column-fluid" id="kt_content">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="font-weight-bold text-info text-uppercase mb-1 text-xs">
                                    Total Contact Organization</div>
                                <div class="h5 font-weight-bold mb-0 text-gray-800">{{ $contact }}</div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center gap-md-5 gap-2 py-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        List of Contacts Organization Data
                    </div>
                    <!--end::Search-->
                </div>
                <!--end::Card title-->
            ...
            <div class="card-body pt-0">
                @livewire('cms::datatables.contact-org-datatable')
            </div>
        </div>
    </div>

...
@section('content')
    <div class="toolbar mb-lg-7 mb-5" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex fw-bold fs-3 my-1 text-gray-900">News & Subscribe</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
    ...
    <div class="content flex-column-fluid" id="kt_content">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 font-weight-bold mb-0 text-gray-800">{{ $newsub }}</div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                @livewire('cms::datatables.new-sub-datatable')
            </div>
        </div>
    </div>
@endsection

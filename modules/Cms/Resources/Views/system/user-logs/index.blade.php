    ...
    <section>
        <div class="card border-0">
            ...
            <div class="card-body border-top border-light">
                <form class="form-block row gy-2 gx-2" action="{{ route('cms::system.user-logs.index') }}" method="get">
                    ...
                    <div class="col-auto">
                        <a class="btn btn-light" href="{{ route('cms::system.user-logs.index', request()->only('trashed', 'closed')) }}"><i class="mdi mdi-refresh"></i> <span class="d-sm-none">Reset</span></a>
                    </div>
                    <div class="col-auto">
                        ...
                        @forelse($logs as $log)
                            <tr>
                                ...
                                <td class="py-2 text-end" nowrap>
                                    @can('destroy', $log)
                                        <form class="form-block form-confirm d-inline" action="{{ route('cms::system.user-logs.destroy', ['log' => $log->id, 'next' => url()->current()]) }}" method="post"> @csrf @method('delete')

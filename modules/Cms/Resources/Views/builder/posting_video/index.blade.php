...
@section('title', 'Posting Video')

@section('navtitle', 'Posting Video')

@section('content')

    @if (str_contains(url()->full(), 'create') || str_contains(url()->full(), 'edit'))
        @livewire('cms::builder.posting-video')
    @else
        <div>
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"><a href="">Posting Video</a></li>
                    </ol>
                    ...
                    <div class="card my-4 border shadow-none">
                        <div class="card-header border-bottom bg-body p-4">
                            <div class="row g-3 justify-content-between align-items-center">
                                ...
                                <div class="col col-md-auto">
                                    <a class="btn btn-sm btn-phoenix-primary ms-2" href="<?= route('cms::builder.posting_video.create') ?>?id_menu={{ $id_menu }}&post_id={{ $post_id }}">
                        ...
                        <div class="card-body">
                            @livewire('cms::datatables.posting-video-datatable')
                        </div>
                    </div>
                </div>
            </main>

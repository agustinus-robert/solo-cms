...
<html data-navigation-type="default" data-navbar-horizontal-shape="default" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>YSBY Dashboard  - {{date('Y')}}</title>
    ...
    <meta name="msapplication-TileImage" content="{{url('public/images/mstile-150x150.png')}}">
    <meta name="theme-color" content="#ffffff">
    <script src="{{url('public/fenix/js/imagesloaded.pkgd.min.js')}}"></script>
    <script src="{{url('public/fenix/js/simplebar.min.js')}}"></script>
    <script src="{{url('public/fenix/js/config.js')}}"></script>
    ...
    <link href="{{url('public/fenix/css/simplebar.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="https://unicons.iconscout.com/release/v4.0.8/css/line.css">
    <link href="{{url('public/fenix/css/theme-rtl.min.css')}}" type="text/css" rel="stylesheet" id="style-rtl">
    <link href="{{url('public/fenix/css/theme.min.css')}}" type="text/css" rel="stylesheet" id="style-default">
    <link href="{{url('public/fenix/css/user-rtl.min.css')}}" type="text/css" rel="stylesheet" id="user-style-rtl">
    <link href="{{url('public/fenix/css/user.min.css')}}" type="text/css" rel="stylesheet" id="user-style-default">
...
<!-- include summernote css/js -->
    ...
    <link href="{{url('public/fenix/css/leaflet.css')}}" rel="stylesheet">
    <link href="{{url('public/fenix/css/MarkerCluster.css')}}" rel="stylesheet">
    <link href="{{url('public/fenix/css/MarkerCluster.Default.css')}}" rel="stylesheet">
  ...
  <body>
    ...
    <main class="main" id="top">
                        ...
                        <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-{{$val->id}}">
                          ...
                          <?php if(isset($val->children)){
                             ...
                             <?php  } else if(isset(get_needed($valuet->id)[0]->type) && get_needed($valuet->id)[0]->type == '3'){ ?>
                                    <li class="nav-item"><a class="nav-link" href="{{url('category')}}/<?=$valuet->id?>">
                            ...
                            <?php } else if(isset(get_needed($valuet->id)[0]->type) && get_needed($valuet->id)[0]->type == '5'){ ?>
                                    <li class="nav-item"><a class="nav-link" href="{{url(get_menu_id($valuet->id)->custom_links)}}">
                                        <div class="d-flex align-items-center"><i class="<?=get_needed($valuet->id)[0]->icon?>"></i><span class="nav-link-text"><?=json_decode(get_needed($valuet->id)[0]->title, true)[@$_COOKIE['k_language']]?></span></div></a>
                                    </li> 
                            <?php } 
                                }
        ...
        <div class="collapse navbar-collapse justify-content-between">
          <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index.html">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center">
                  <img src="{{url('public/image_globals/ysby.png')}}" width="250" />
                </div>
              </div>
            </a>
          </div>
              ...
              <div class="scrollbar-overlay" style="max-height: 30rem;">
                <div class="list pb-3">
                  ...
                  <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="apps/e-commerce/landing/product-details.html">
                      <div class="file-thumbnail me-2"><img class="h-100 w-100 fit-cover rounded-3" src="images/3.png" alt="" /></div>
                      <div class="flex-1">
                    ...
                    <a class="dropdown-item py-2 d-flex align-items-center" href="apps/e-commerce/landing/product-details.html">
                      <div class="file-thumbnail me-2"><img class="img-fluid" src="images/3.png" alt="" /></div>
                      <div class="flex-1">
                  ...
                  <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="pages/members.html">
                      <div class="avatar avatar-l status-online  me-2 text-body">
                        <img class="rounded-circle " src="images/10.webp" alt="" />
                      </div>
                      <div class="flex-1">
          ...
          <ul class="navbar-nav navbar-nav-icons flex-row">
                  ...
                  <div class="card-body p-0">
                    <div class="scrollbar-overlay" style="height: 27rem;">
                      ...
                      <div class="px-2 px-sm-3 py-3 notification-card position-relative unread border-bottom">
                        <div class="d-flex align-items-center justify-content-between position-relative">
                          <div class="d-flex">
                            <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{url('public/image_globals/avatas.png')}}" alt="" /></div>
                            <div class="flex-1 me-sm-3">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-l ">
                  <img class="rounded-circle " src="{{url('public/image_globals/avatas.png')}}" alt="" />
                </div>
              </a>
                ...
                <div class="card position-relative border-0">
                  ...
                  <div class="card-footer p-0 border-top border-translucent">
                    ...
                    <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                        @csrf
                    </form> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
      ...
      <nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
        <div class="navbar-logo">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="index.html">
            <div class="d-flex align-items-center">
              <div class="d-flex align-items-center"><img src="{{url('public/image_globals/ysby.png')}}" width="250" />
              </div>
            </div>
          </a>
        </div>
        ...
        <footer class="footer">
          <div class="row g-0 justify-content-between align-items-center h-100">
            <div class="col-12 col-sm-auto text-center">
              <p class="mb-0 mt-2 mt-sm-0 text-body">YSBY <span class="d-none d-sm-inline-block"></span><span class="d-none d-sm-inline-block mx-1">|</span><br class="d-sm-none" />@php echo date('Y'); @endphp &copy;<a class="mx-1" href="https://therichpost.com">Pemad</a></p>
            </div>
            <div class="col-12 col-sm-auto text-center">
            ...
            <div class="card-body chat p-0">
              <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
                ...
                <div class="text-center mt-auto">
                  <div class="avatar avatar-3xl status-online"><img class="rounded-circle border border-3 border-light-subtle" src="images/30.webp" alt="" /></div>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar px-card" id="themeController">
        <div class="setting-panel-item mt-0">
          ...
          <div class="row gx-2">
            <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio" value="light" data-theme-control="phoenixTheme" /><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{url('public/fenix/images/default-light.png')}}" alt=""/></span><span class="label-text">Light</span></label></div>
            <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="phoenixTheme" /><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{url('public/fenix/images/default-dark.png')}}" alt=""/></span><span class="label-text"> Dark</span></label></div>
            <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio" value="auto" data-theme-control="phoenixTheme" /><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{url('public/fenix/images/auto.png')}}" alt=""/></span><span class="label-text"> Auto</span></label></div>
          </div>
        </div>
        ...
        <div class="setting-panel-item">
          ...
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbarPositionVertical" name="navigation-type" type="radio" value="vertical" data-theme-control="phoenixNavbarPosition" /><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionVertical"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="{{url('public/fenix/images/default-light.png')}}" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{url('public/fenix/images/default-dark.png')}}" alt=""/></span><span class="label-text">Vertical</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio" value="horizontal" data-theme-control="phoenixNavbarPosition" /><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="{{url('public/fenix/images/top-default.png')}}" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{url('public/fenix/images/top-default-dark.png')}}" alt=""/></span><span class="label-text"> Horizontal</span></label></div>
          </div>
        </div>
        <div class="setting-panel-item">
          <h5 class="setting-panel-item-title">Vertical Navbar Appearance</h5>
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbar-style-default" type="radio" name="config.name" value="default" data-theme-control="phoenixNavbarVerticalStyle" /><label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-default"> <img class="img-fluid img-prototype d-dark-none" src="{{url('public/fenix/images/default-light.png')}}" alt="" /><img class="img-fluid img-prototype d-light-none" src="{{url('public/fenix/images/default-dark.png')}}" alt="" /><span class="label-text d-dark-none"> Default</span><span class="label-text d-light-none">Default</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbar-style-dark" type="radio" name="config.name" value="darker" data-theme-control="phoenixNavbarVerticalStyle" /><label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-dark"> <img class="img-fluid img-prototype d-dark-none" src="{{url('public/fenix/images/vertical-darker.png')}}" alt="" /><img class="img-fluid img-prototype d-light-none" src="{{url('public/fenix/images/vertical-lighter.png')}}" alt="" /><span class="label-text d-dark-none"> Darker</span><span class="label-text d-light-none">Lighter</span></label></div>
          </div>
        </div>
        <div class="setting-panel-item">
          <h5 class="setting-panel-item-title">Horizontal Navbar Shape</h5>
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbarShapeDefault" name="navbar-shape" type="radio" value="default" data-theme-control="phoenixNavbarTopShape" /><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeDefault"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{url('public/fenix/images/top-default.png')}}" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="{{url('public/fenix/images/top-default-dark.png')}}" alt=""/></span><span class="label-text">Default</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio" value="slim" data-theme-control="phoenixNavbarTopShape" /><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{url('public/fenix/images/top-slim.png')}}" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="{{url('public/fenix/images/top-slim-dark.png')}}" alt=""/></span><span class="label-text"> Slim</span></label></div>
          </div>
        </div>
        <div class="setting-panel-item">
          <h5 class="setting-panel-item-title">Horizontal Navbar Appearance</h5>
          <div class="row gx-2">
            <div class="col-6"><input class="btn-check" id="navbarTopDefault" name="navbar-top-style" type="radio" value="default" data-theme-control="phoenixNavbarTopStyle" /><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{url('public/fenix/images/top-default.png')}}" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="images/top-style-darker.png" alt=""/></span><span class="label-text">Default</span></label></div>
            <div class="col-6"><input class="btn-check" id="navbarTopDarker" name="navbar-top-style" type="radio" value="darker" data-theme-control="phoenixNavbarTopStyle" /><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker"> <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{url('public/fenix/images/navbar-top-style-light.png')}}" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="images/top-style-lighter.png" alt=""/></span><span class="label-text d-dark-none">Darker</span><span class="label-text d-light-none">Lighter</span></label></div>
          </div>
        </div>
        <div class="setting-panel-item">
          <h5 class="setting-panel-item-title">Role</h5>
          <div class="row gx-2 m-2">
             <div class="code-to-copy">
                <select id="change_page" class="form-select" aria-label="Default select example">
        ...
        <div class="setting-panel-item">
          <h5 class="setting-panel-item-title">Language</h5>
          <div class="row gx-2 m-2">
             <div class="code-to-copy">
    ...
    <script src="{{url('public/fenix/js/popper.min.js')}}"></script>
    <script src="{{url('public/fenix/js/bootstrap.min.js')}}"></script>
    <script src="{{url('public/fenix/js/anchor.min.js')}}"></script>
    <script src="{{url('public/fenix/js/is.min.js')}}"></script>
    <script src="{{url('public/fenix/js/all.min.js')}}"></script>
    <script src="{{url('public/fenix/js/lodash.min.js')}}"></script>
    <script src="https://cdnjs.cloudflare.com/polyfill/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{url('public/fenix/js/list.min.js')}}"></script>
    <script src="{{url('public/fenix/js/feather.min.js')}}"></script>
    <script src="{{url('public/fenix/js/dayjs.min.js')}}"></script>
    <script src="{{url('public/fenix/js/phoenix.js')}}"></script>
    <script src="{{url('public/fenix/js/echarts.min.js')}}"></script>
    <script src="{{url('public/fenix/js/leaflet.js')}}"></script>
    <script src="{{url('public/fenix/js/leaflet.markercluster.js')}}"></script>
    <script src="{{url('public/fenix/js/leaflet-tilelayer-colorfilter.min.js')}}"></script>
    <script src="{{url('public/fenix/js/ecommerce-dashboard.js')}}"></script>

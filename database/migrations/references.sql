...
INSERT INTO ref_countries (id, kd, name, native, phones, continent, capital, currencies, languages) VALUES
...
(44, 'CI', 'Ivory Coast', 'Côte dIvoire', '[\"225\"]', 'AF', 'Yamoussoukro', '[\"XOF\"]', '[\"fr\"]'),
...
(78, 'GD', 'Grenada', 'Grenada', '[\"1473\"]', 'NA', 'St. Georges', '[\"XCD\"]', '[\"en\"]'),
...
(215, 'TD', 'Chad', 'Tchad', '[\"235\"]', 'AF', 'NDjamena', '[\"XAF\"]', '[\"fr\",\"ar\"]'),
...
(224, 'TO', 'Tonga', 'Tonga', '[\"676\"]', 'OC', 'Nukualofa', '[\"TOP\"]', '[\"en\",\"to\"]'),
...
(246, 'YE', 'Yemen', 'اليَمَن', '[\"967\"]', 'AS', 'Sanaa', '[\"YER\"]', '[\"ar\"]'),
...
CREATE TABLE ref_province_regencies (
  ...
  name VARCHAR(191) NOT NULL,
  PRIMARY KEY (id),
  FOREIGN KEY (province_id) REFERENCES ref_provinces(id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX ref_countries_kd_idx ON ref_countries (kd);

CREATE UNIQUE INDEX ref_grade_levels_kd_idx ON ref_grade_levels (kd);

CREATE INDEX ref_grade_levels_grade_id_idx ON ref_grade_levels (grade_id);

CREATE INDEX ref_province_regencies_province_id_idx ON ref_province_regencies (province_id);

CREATE INDEX ref_province_regency_districts_regency_id_idx ON ref_province_regency_districts (regency_id);

ALTER TABLE ref_achievement_nums ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_achievement_nums_id_seq;

CREATE SEQUENCE ref_achievement_nums_id_seq START 8;
ALTER TABLE ref_achievement_nums ALTER COLUMN id SET DEFAULT nextval('ref_achievement_nums_id_seq');
SELECT setval('ref_achievement_nums_id_seq', COALESCE((SELECT MAX(id) FROM ref_achievement_nums), 7));

ALTER TABLE ref_achievement_types ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_achievement_types_id_seq;

CREATE SEQUENCE ref_achievement_types_id_seq START 10;
ALTER TABLE ref_achievement_types ALTER COLUMN id SET DEFAULT nextval('ref_achievement_types_id_seq');
SELECT setval('ref_achievement_types_id_seq', COALESCE((SELECT MAX(id) FROM ref_achievement_types), 9));

ALTER TABLE ref_countries ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_countries_id_seq;

CREATE SEQUENCE ref_countries_id_seq START 244;
ALTER TABLE ref_countries ALTER COLUMN id SET DEFAULT nextval('ref_countries_id_seq');
SELECT setval('ref_countries_id_seq', COALESCE((SELECT MAX(id) FROM ref_countries), 243));

ALTER TABLE ref_creation_ctgs ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_creation_ctgs_id_seq;

CREATE SEQUENCE ref_creation_ctgs_id_seq START 7;
ALTER TABLE ref_creation_ctgs ALTER COLUMN id SET DEFAULT nextval('ref_creation_ctgs_id_seq');
SELECT setval('ref_creation_ctgs_id_seq', COALESCE((SELECT MAX(id) FROM ref_creation_ctgs), 6));

ALTER TABLE ref_desires ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_desires_id_seq;

CREATE SEQUENCE ref_desires_id_seq START 9;
ALTER TABLE ref_desires ALTER COLUMN id SET DEFAULT nextval('ref_desires_id_seq');
SELECT setval('ref_desires_id_seq', COALESCE((SELECT MAX(id) FROM ref_desires), 8));

ALTER TABLE ref_disabilities ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_disabilities_id_seq;

CREATE SEQUENCE ref_disabilities_id_seq START 10;
ALTER TABLE ref_disabilities ALTER COLUMN id SET DEFAULT nextval('ref_disabilities_id_seq');
SELECT setval('ref_disabilities_id_seq', COALESCE((SELECT MAX(id) FROM ref_disabilities), 9));

ALTER TABLE ref_employments ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_employments_id_seq;

CREATE SEQUENCE ref_employments_id_seq START 19;
ALTER TABLE ref_employments ALTER COLUMN id SET DEFAULT nextval('ref_employments_id_seq');
SELECT setval('ref_employments_id_seq', COALESCE((SELECT MAX(id) FROM ref_employments), 18));

ALTER TABLE ref_grades ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_grades_id_seq;

CREATE SEQUENCE ref_grades_id_seq START 13;
ALTER TABLE ref_grades ALTER COLUMN id SET DEFAULT nextval('ref_grades_id_seq');
SELECT setval('ref_grades_id_seq', COALESCE((SELECT MAX(id) FROM ref_grades), 12));

ALTER TABLE ref_grade_levels ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_grade_levels_id_seq;

CREATE SEQUENCE ref_grade_levels_id_seq START 13;
ALTER TABLE ref_grade_levels ALTER COLUMN id SET DEFAULT nextval('ref_grade_levels_id_seq');
SELECT setval('ref_grade_levels_id_seq', COALESCE((SELECT MAX(id) FROM ref_grade_levels), 12));

ALTER TABLE ref_habitations ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_habitations_id_seq;

CREATE SEQUENCE ref_habitations_id_seq START 8;
ALTER TABLE ref_habitations ALTER COLUMN id SET DEFAULT nextval('ref_habitations_id_seq');
SELECT setval('ref_habitations_id_seq', COALESCE((SELECT MAX(id) FROM ref_habitations), 7));


ALTER TABLE ref_hobbies ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_hobbies_id_seq;

CREATE SEQUENCE ref_hobbies_id_seq START 7;
ALTER TABLE ref_hobbies ALTER COLUMN id SET DEFAULT nextval('ref_hobbies_id_seq');
SELECT setval('ref_hobbies_id_seq', COALESCE((SELECT MAX(id) FROM ref_hobbies), 6));


ALTER TABLE ref_organization_positions ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_organization_positions_id_seq;

CREATE SEQUENCE ref_organization_positions_id_seq START 9;
ALTER TABLE ref_organization_positions ALTER COLUMN id SET DEFAULT nextval('ref_organization_positions_id_seq');
SELECT setval('ref_organization_positions_id_seq', COALESCE((SELECT MAX(id) FROM ref_organization_positions), 8));


ALTER TABLE ref_organization_types ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_organization_types_id_seq;

CREATE SEQUENCE ref_organization_types_id_seq START 7;
ALTER TABLE ref_organization_types ALTER COLUMN id SET DEFAULT nextval('ref_organization_types_id_seq');
SELECT setval('ref_organization_types_id_seq', COALESCE((SELECT MAX(id) FROM ref_organization_types), 6));


ALTER TABLE ref_periods ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_periods_id_seq;

CREATE SEQUENCE ref_periods_id_seq START 47;
ALTER TABLE ref_periods ALTER COLUMN id SET DEFAULT nextval('ref_periods_id_seq');
SELECT setval('ref_periods_id_seq', COALESCE((SELECT MAX(id) FROM ref_periods), 46));


ALTER TABLE ref_provinces ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_provinces_id_seq;

CREATE SEQUENCE ref_provinces_id_seq START 95;
ALTER TABLE ref_provinces ALTER COLUMN id SET DEFAULT nextval('ref_provinces_id_seq');
SELECT setval('ref_provinces_id_seq', COALESCE((SELECT MAX(id) FROM ref_provinces), 94));


ALTER TABLE ref_province_regencies ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_province_regencies_id_seq;

CREATE SEQUENCE ref_province_regencies_id_seq START 9472;
ALTER TABLE ref_province_regencies ALTER COLUMN id SET DEFAULT nextval('ref_province_regencies_id_seq');
SELECT setval('ref_province_regencies_id_seq', COALESCE((SELECT MAX(id) FROM ref_province_regencies), 9471));


ALTER TABLE ref_province_regency_districts ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_province_regency_districts_id_seq;

CREATE SEQUENCE ref_province_regency_districts_id_seq START 9471041;
ALTER TABLE ref_province_regency_districts ALTER COLUMN id SET DEFAULT nextval('ref_province_regency_districts_id_seq');
SELECT setval('ref_province_regency_districts_id_seq', COALESCE((SELECT MAX(id) FROM ref_province_regency_districts), 9471040));


ALTER TABLE ref_religions ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_religions_id_seq;

CREATE SEQUENCE ref_religions_id_seq START 7;
ALTER TABLE ref_religions ALTER COLUMN id SET DEFAULT nextval('ref_religions_id_seq');
SELECT setval('ref_religions_id_seq', COALESCE((SELECT MAX(id) FROM ref_religions), 6));


ALTER TABLE ref_salaries ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_salaries_id_seq;
CREATE SEQUENCE ref_salaries_id_seq START 7;

ALTER TABLE ref_salaries ALTER COLUMN id SET DEFAULT nextval('ref_salaries_id_seq');
SELECT setval('ref_salaries_id_seq', COALESCE((SELECT MAX(id) FROM ref_salaries), 6));

ALTER TABLE ref_territories ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS ref_territories_id_seq;

CREATE SEQUENCE ref_territories_id_seq START 8;
ALTER TABLE ref_territories ALTER COLUMN id SET DEFAULT nextval('ref_territories_id_seq');
SELECT setval('ref_territories_id_seq', COALESCE((SELECT MAX(id) FROM ref_territories), 7));

ALTER TABLE ref_transportations ALTER COLUMN id TYPE integer USING id::integer;
DROP SEQUENCE IF EXISTS ref_transportations_id_seq;
CREATE SEQUENCE ref_transportations_id_seq START 8;

ALTER TABLE ref_transportations ALTER COLUMN id SET DEFAULT nextval('ref_transportations_id_seq');
SELECT setval('ref_transportations_id_seq', COALESCE((SELECT MAX(id) FROM ref_transportations), 7));
